...
- **Salvamento automático** em múltiplos destinos:
  - MongoDB (evita duplicatas pelo URL)
  - PostgreSQL (tabela `dados_mong`)
  - Snowflake (tabela `DADOS_MONG`)
...
### 2. PostgreSQL
Configure as variáveis de ambiente (ou edite diretamente no arquivo):
...
### 3. Snowflake
Configure as credenciais do Snowflake:

```powershell
$env:SF_USER="SEU_USUARIO"
$env:SF_PASSWORD="SUA_SENHA"
$env:SF_ACCOUNT="SUA_CONTA"
